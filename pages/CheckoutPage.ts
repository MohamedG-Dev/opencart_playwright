...
export class CheckoutPage {
    ...
    constructor(page: Page) {
        ...
        this.radioGuest = page.getByRole('radio', { name: 'Guest Checkout' })
        ...
        this.txtAddress1 = page.getByLabel('Address 1')
        this.txtAddress2 = page.getByLabel('Address 2')
        this.txtCity = page.getByLabel('City')
        this.txtPin = page.getByLabel('Post Code')
        this.drpCountry = page.getByLabel('Country')
        this.drpState = page.getByLabel('Region / State')
